		...
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				...
				<tr>
					...
					<th>登陆名称</th>
					<td><input name="data.loginname" readonly="readonly" class="easyui-validatebox" data-options="required:true" /></td>
					<th colspan="4">模板预览</th>
					<td rowspan="8"><img id="moban1" src="" style="width: 280px; height: 400px;"></td>
				</tr>
				<tr>
					<th>姓名</th>
					<td><input name="data.name" /></td>
					<th>模板</th>
					<td><select class="easyui-combobox" id="checkMOBAN" name="data.qrmoban" data-options="panelHeight:'auto',editable:false" style="width: 155px;" >
				...
				<tr>
					...
					<th>二维码</th>
					<td><input name="data.qrPhoto" readonly="readonly" style="display: none;" /> <img id="qrPhoto" src="" style="width: 200px; height: 200px;"></td>
				</tr>
				<tr>
				<td></td><td><input type="button" value="编辑" onclick="submitForm()"></td></td>
				<td></td><td><input type="button" value="预览" onclick="submitSee()"></td></tr>
				<tr></tr>
			</table>
		</fieldset>
	</form></td>
