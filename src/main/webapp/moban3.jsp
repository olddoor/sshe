...
<head lang="en">
   ...
   @media only screen and (min-width :1025px){
	body{ background: url(<%=contextPath%>/static/images2/bodybg_b_1.jpg) center center no-repeat !important; background-size: cover;}
}
   </style>
...
<!-----dialog-end------> 
     ...
     <div class="info_b_2">
     <ul>
     <li><span class="company_b"><%=u.getCompany()%></span></li>
