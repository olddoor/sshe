...
$.extend($.fn.combotree.defaults, sy.loadFilter);  //合并多个对象
$.extend($.fn.tree.defaults, sy.loadFilter);  //合并多个对象
$.extend({
	test123:function(){alert('test123 函数 来自$.extend')}
	});
/**
